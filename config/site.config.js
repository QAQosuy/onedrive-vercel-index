...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'neiula@r0w1.onmicrosoft.com',
  ...
  email: 'neiula@r0w1.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/QAQosuy/onedrive-vercel-index',
    },
  ],
  links: [
    {
      name: 'Blog',
      link: 'https://neiula.top',
    },
  ],
